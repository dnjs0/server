...
public class Ex01 {
    public static void main(String[] args) {
        String clientId = "7aTYocXbgCmv24Skitjw"; //애플리케이션 클라이언트 아이디
        String clientSecret = "vkVPAJJHh7"; //애플리케이션 클라이언트 시크릿
        ...
        try {
             ...
             * 
             * for(Object obj : list) { System.out.println(((JSONObject)obj).get("name"));
